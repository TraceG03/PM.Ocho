    ...
    <div className="pb-20 min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-white dark:bg-gray-800 shadow-sm sticky top-0 z-10">
        <div className="px-4 py-4">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">AI-generated project reports</p>
        </div>
      </div>

      {/* Report Generation Controls */}
      <div className="px-4 mt-4 space-y-4">
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-sm p-4 space-y-3">
        ...
        {reportText && (
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-sm p-4">
            <div className="flex items-center justify-between mb-3">
              <h2 className="font-semibold text-gray-900 dark:text-white">Generated Report</h2>
              <div className="flex gap-2">
                <button
            ...
            <textarea
              ...
              rows={15}
              className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-accent-purple resize-none font-mono text-sm"
